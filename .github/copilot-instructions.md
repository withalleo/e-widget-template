...
3. Write the result to `dist/<widget-name>.Alleo-eWidget.txt` (full HTML content
   plus a `WIDGETSETTINGS:` import footer, `.txt` extension — the Alleo file
...
- Importable examples are in `samples/` (`*.Alleo-eWidget.txt`).
